...
/**
 * Created by Carmina on 2/10/2015.
 *
 * http://stackoverflow.com/questions/17776051/how-to-implement-gyroscope-sensor-in-android
 */
public class GyroscopeGif implements SensorEventListener{
    ...
    private static final String TAG = GyroscopeGif.class.getSimpleName();
    ...
    public GyroscopeGif(Context context, AnimationDrawable  gif, ImageView imageView, TextView yLabel) {
        mContext = context;
        mGif = gif;
            ...
            if ((type==Sensor.TYPE_MAGNETIC_FIELD) || (type==Sensor.TYPE_ACCELEROMETER)) {
                ...
                if (SensorManager.getRotationMatrix(mRotationMatrix, null, bufferedAccelGData, bufferedMagnetData)){
                   ...
                   // debugSensorData(event);
                    mYLabel.setText("Y: " + event.values[0]);
                }
            }
        }
